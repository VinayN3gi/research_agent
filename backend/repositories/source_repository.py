...
class SourceRepository:
    ...
    def create(self, run_id: str, title: str, url: str, domain: Optional[str] = None, markdown: Optional[str] = None) -> Source:
        source = Source(run_id=run_id, title=title, url=url, domain=domain, markdown=markdown)
        self.db.add(source)
        self.db.commit()
